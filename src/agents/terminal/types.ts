/**
 * Dangerous command detection types and patterns.
 *
 * Provides regex patterns for detecting potentially destructive shell commands,
 * covering file system operations, permission changes, system services, and more.
 *
 * Pattern source: Derived from Hermes Agent security practices.
 */
...
/**
 * Dangerous command patterns for shell execution safety.
